...
$(document).ready(function () {
    ...
    $('.sidebar-unor li').on('click', function () {
        $(".sidebar-unor li").removeClass('active');
        $(this).addClass("active");
        var sidebar = $(this).attr("data-attr");
        $(".sidebar-wrapper").attr("sidebar-layout", sidebar);
    });

    $('.sidebar-main-bg-unor li').on('click', function () {
        $(".sidebar-main-bg-unor li").removeClass('active')
        $(this).addClass("active")
